...
class buildHorizontalList extends StatefulWidget {
  ...
  final List<Sections> sectionDetail;
          ...
          children: [
            SizedBox(
              ...
              child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: widget.sectionDetail.length,
                  itemBuilder: (BuildContext context, int index) {
                    String courseId = widget.sectionDetail[index].id;
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        "${widget.sectionDetail[index].lessons_count} ${AppLocalizations.of(context)!.lessons}",
                                        style: TextStyle(
                                            color: whiteColor,
                                            fontSize: 12,
                                    ...
                                    children: [
                                      Flexible(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              "widget.sectionDetail[index].instructors![0].name[0].value",
                                              style: TextStyle(
