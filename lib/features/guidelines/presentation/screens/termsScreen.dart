      ...
      appBar: PreferredSize(
        ...
        child: Container(
          child: AppBar(
            ...
            title: Text(
              titleVisible
                  ? AppLocalizations.of(context)!.termsAndConditionsAbout
                  : "",
            ...
            builder: (context, state) {
              if (state is GuidelinesLoadingState) {
                ...
                return buildInitialInput(
                    terms: state.guidelines[0].terms_and_conditions);
      ...
      child: Column(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)!.termsAnd,
                      style: TextStyle(
                          color: blackColor,
          ...
          Padding(
            ...
            child: Text(
              selectedLanguage == 'am_amh' ? terms[1].value : terms[0].value,
              style: TextStyle(
                  color: blackColor,
